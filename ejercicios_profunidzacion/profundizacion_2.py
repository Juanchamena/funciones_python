...
def contar(lista_numeros, numero_repitente):
    repeticiones = lista_numeros.count(numero_repitente)
    return repeticiones 
...
if __name__ == '__main__':
    ...
    # print(lista_numeros)
    print("La lista random generada es:", lista_numeros)
    # Luego quiero averiguar cuantas veces se repite el numero 3
    # en la lista aleatoria creada
    # cantidad_tres = contar(lista_numeros, 3)
    cantidad_tres = contar(lista_numeros, numero_repitente)
    # print(cantidad_tres)
